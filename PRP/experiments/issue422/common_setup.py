...
class IssueExperiment(DownwardExperiment):
    ...
    # TO_DO: Once we have reference results, we should add "quality".
    # TO_DO: Add something about errors/exit codes.
    ...
    def revision_nicks(self):
        # TO_DO: Once the add_algorithm() API is available we should get
