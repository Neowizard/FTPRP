...
class Problem(object):
    ...
    def _export_domain (self, fp, sp="  "):
        ...
        # types
        #TO_DO likely wrong, doesn't capture the type hierarchy
    ...
    def _parse_domain(self, f_domain):
        ...
        #TO_DO this may not be correct, depending on the type hierchy
    ...
    def _parse_problem(self, f_problem):
        ...
        #TO_DO this may not be valid with a non-flat type hierchy
