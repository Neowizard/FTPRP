...
/*
  TO_DO: Perform some memory profiling on this class.
...
/*
  ...
  TO_DO: IntRelations, along with the efficient way of constructing
  ...
  TO_DO: IntRelations currently only work for relations on {0, ..., K -
