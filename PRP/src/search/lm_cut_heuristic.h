...
// TO_DO: Fix duplication with the other relaxation heuristics.
...
class Options;
/* TO_DO: Check the impact of using unary relaxed operators instead of
   multi-effect ones.
...
/* TO_DO: In some very preliminary tests in the IPC-2008 Elevators
...
struct RelaxedProposition {
    ...
    int h_max_cost;
    /* TO_DO: Also add the rpg depth? The Python implementation used
