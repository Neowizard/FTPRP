...
/* TO_DO: The following class should probably be renamed. It encodes
...
// TO_DO: This is a general tool that probably belongs somewhere else.
template<class T>
...
void ShrinkBisimulation::shrink(
    ...
    // TO_DO: Explain this min(target, threshold) stuff. Also, make the
...
void ShrinkBisimulation::shrink_atomic(Abstraction &abs) {
    ...
    // TO_DO/HACK: Come up with a better way to do this than generating
...
void ShrinkBisimulation::compute_signatures(
    ...
    /* TO_DO: Should we sort an index set rather than shuffle the whole
...
void ShrinkBisimulation::compute_abstraction(
    ...
    // assert(num_groups <= target_size); // TO_DO: We currently violate this; see issue250
...
static ShrinkStrategy *_parse(OptionParser &parser) {
    ...
    parser.add_option<int>("threshold", "TO_DO: document", "-1");  // default: same as max_states
    parser.add_option<bool>("group_by_h", "TO_DO: document", "false");
