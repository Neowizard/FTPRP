...
Abstraction *MergeAndShrinkHeuristic::build_abstraction() {
    // TO_DO: We're leaking memory here in various ways. Fix this.
    ...
    while (!order.done()) {
        ...
        // TO_DO: When using nonlinear merge strategies, make sure not
        ...
        // TO_DO: Make shrink_before_merge return a pair of bools
...
static Heuristic *_parse(OptionParser &parser) {
    ...
    // TO_DO: better documentation what each parameter does
    vector<string> merge_strategies;
    vector<string> merge_strategies_doc;
    //TO_DO: it's a bit dangerous that the merge strategies here
    ...
    merge_strategies_doc.push_back("TO_DO");
    ...
    // TO_DO: Rename option name to "use_label_reduction" to be
