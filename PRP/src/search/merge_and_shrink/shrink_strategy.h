...
public:
    // HACK/TO_DO: The following method would usually be protected, but
...
public:
    ...
    */
    ...
    /* TO_DO: Make sure that *all* shrink strategies prune irrelevant
    ...
    */
    ...
    // TO_DO: Should all three of these be virtual?
    // TO_DO: Should all three of these be public?
