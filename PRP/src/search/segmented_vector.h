...
// TO_DO: Get rid of the code duplication here. How to do it without
...
class SegmentedVector {
    ...
    // TO_DO: Try to find a good value for SEGMENT_BYTES.
...
public:
    ...
    ~SegmentedArrayVector() {
        // TO_DO Factor out common code with SegmentedVector. In particular
