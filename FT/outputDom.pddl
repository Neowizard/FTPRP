...
(:requirements :equality :negative-preconditions :typing)
	...
	(:action pick-up-from-table_FTD_e0_0_0
	:parameters  ( ?b - block)
	:precondition 
		(and
	...
	(:action pick-up-from-table_FTD_e1_0_0
	:parameters  ( ?b - block)
	:precondition 
		(and
		(not (not-in-pick-up-from-table))
	...
	(:action pick-up-from-table_FTD_e0_1_1
	:parameters  ( ?b - block)
	:precondition 
		(and
		(not (not-in-pick-up-from-table))
	...
	(:action pick-up-from-table_FTD_e1_1_1
	:parameters  ( ?b - block)
	:precondition 
		(and
		(not (not-in-pick-up-from-table))
	...
	(:action pick-up-from-table_FTD_e0_2_1
	:parameters  ( ?b - block)
	:precondition 
		(and
		(not (not-in-pick-up-from-table))
	...
	(:action pick-up-from-table_FTD_e1_2_1
	:parameters  ( ?b - block)
	:precondition 
		(and
		(not (not-in-pick-up-from-table))
	...
	(:action pick-up-from-table_FTD_e0_3_1
	:parameters  ( ?b - block)
	:precondition 
		(and
		(not (not-in-pick-up-from-table))
	...
	(:action pick-up-from-table_FTD_e1_3_1
	:parameters  ( ?b - block)
	:precondition 
		(and
		(not (not-in-pick-up-from-table))
	...
	(:action put-on-block_FTD_e0_0_0
	:parameters  ( ?b1 - block ?b2 - block)
	:precondition 
		(and
	...
	(:action put-on-block_FTD_e1_0_0
	:parameters  ( ?b1 - block ?b2 - block)
	:precondition 
		(and
		(not (not-in-put-on-block))
	...
	(:action put-on-block_FTD_e0_1_1
	:parameters  ( ?b1 - block ?b2 - block)
	:precondition 
		(and
		(not (not-in-put-on-block))
	...
	(:action put-on-block_FTD_e1_1_1
	:parameters  ( ?b1 - block ?b2 - block)
	:precondition 
		(and
		(not (not-in-put-on-block))
	...
	(:action put-on-block_FTD_e0_2_1
	:parameters  ( ?b1 - block ?b2 - block)
	:precondition 
		(and
		(not (not-in-put-on-block))
	...
	(:action put-on-block_FTD_e1_2_1
	:parameters  ( ?b1 - block ?b2 - block)
	:precondition 
		(and
		(not (not-in-put-on-block))
	...
	(:action put-on-block_FTD_e0_3_1
	:parameters  ( ?b1 - block ?b2 - block)
	:precondition 
		(and
		(not (not-in-put-on-block))
	...
	(:action put-on-block_FTD_e1_3_1
	:parameters  ( ?b1 - block ?b2 - block)
	:precondition 
		(and
		(not (not-in-put-on-block))
	...
	(:action put-tower-on-block_FTD_e0_0_0
	:parameters  ( ?b1 - block ?b2 - block ?b3 - block)
	:precondition 
		(and
	...
	(:action put-tower-on-block_FTD_e1_0_0
	:parameters  ( ?b1 - block ?b2 - block ?b3 - block)
	:precondition 
		(and
		(not (not-in-put-tower-on-block))
	...
	(:action put-tower-on-block_FTD_e0_1_1
	:parameters  ( ?b1 - block ?b2 - block ?b3 - block)
	:precondition 
		(and
		(not (not-in-put-tower-on-block))
	...
	(:action put-tower-on-block_FTD_e1_1_1
	:parameters  ( ?b1 - block ?b2 - block ?b3 - block)
	:precondition 
		(and
		(not (not-in-put-tower-on-block))
	...
	(:action put-tower-on-block_FTD_e0_2_1
	:parameters  ( ?b1 - block ?b2 - block ?b3 - block)
	:precondition 
		(and
		(not (not-in-put-tower-on-block))
	...
	(:action put-tower-on-block_FTD_e1_2_1
	:parameters  ( ?b1 - block ?b2 - block ?b3 - block)
	:precondition 
		(and
		(not (not-in-put-tower-on-block))
	...
	(:action put-tower-on-block_FTD_e0_3_1
	:parameters  ( ?b1 - block ?b2 - block ?b3 - block)
	:precondition 
		(and
		(not (not-in-put-tower-on-block))
	...
	(:action put-tower-on-block_FTD_e1_3_1
	:parameters  ( ?b1 - block ?b2 - block ?b3 - block)
	:precondition 
		(and
		(not (not-in-put-tower-on-block))
